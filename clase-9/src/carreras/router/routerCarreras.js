...
routerCarreras.get('/', (req, res, next) => {
    let carreras
    try {
        if (req.query.tema) {
...
routerCarreras.get('/:id', (req, res, next) => {
    try {
...
routerCarreras.post('/', (req, res, next) => {
    try {
...
routerCarreras.delete('/:id', (req, res, next) => {
    try {
...
routerCarreras.put('/:id', (req, res, next) => {
    try {
