...
import daoPersonas from '../src/personas/database/personasDao.js'
            ...
            describe('al intentar agregar una nueva', () => {
                ...
                describe('si los datos válidos', () => {
                    ...
                    it('la crea, la guarda, y la devuelve', async () => {
                        ...
                        const personasAntes = await daoPersonas.recuperarPersonas()
                        ...
                        const personasDespues = await daoPersonas.recuperarPersonas()
                ...
                describe('si el dni no es numerico', () => {
                    it('no agrega nada y devuelve un error', async () => {
                        const personasAntes = daoPersonas.recuperarPersonas()
                        const datosPersona = {
                            nombre: "josefa",
                            dni: 'abc'
                        }
                        ...
                        const personasDespues = daoPersonas.recuperarPersonas()
